...
class AddReviewForm extends React.Component {
  ...
  handleValidation() {
    if (
      this.state.starsError === true ||
      this.state.doRecommendError === true ||
      this.state.nicknameError === true ||
      this.state.bodyError === true ||
      this.state.qualityError === true ||
      this.state.comfortError === true ||
      this.state.sizeError === true ||
      this.state.lengthError === true ||
      this.state.widthError === true ||
      this.state.fitError === true ||
  ...
  handleSubmit() {
    ...
    const comfortId = this.state.meta.Comfort
      ? this.state.meta.Comfort.id
      : null;
    const fitId = this.state.meta.Fit ? this.state.meta.Fit.id : null;
    const qualityId = this.state.meta.Quality
      ? this.state.meta.Quality.id
      : null;
  ...
  render() {
    ...
    if (this.state.sentReview) {
      ...
      reviewSent = (
        <Button id='submitReviewButton' onClick={this.validate}>
          Post Review
        </Button>
      );
    }
    ...
    if (this.state.photos.length < 5) {
      addPhotoButton = (
        <Button id='addPhotoButton' onClick={this.handlePhotos}>
          Attach
        </Button>
      );
    }
    ...
    if (this.state.photos[0]) {
      photoOne = (
        <Image
          thumbnail
          id='imageThumbnail'
          onClick={this.handlePhotoLightbox}
    ...
    if (this.state.meta.Quality) {
      quality = (
        <Form.Group>
          <Form.Label id='formQuestions'>
            How Was the Quality of the Product You Recieved*
          </Form.Label>
          <Form.Control
            id='reviewDropdown'
            as='select'
            ...
            name='quality'
            className={this.state.qualityError ? 'error' : ''}>
    ...
    if (this.state.meta.Comfort) {
      comfort = (
        <Form.Group>
          <Form.Label id='formQuestions'>
            How Comfortable is the Product Your Ordered*
          </Form.Label>
          <Form.Control
            id='reviewDropdown'
            as='select'
            ...
            onChange={this.handleChange}
            name='comfort'
            className={this.state.comfortError ? 'error' : ''}>
            <option value={0}>None Selected</option>
            <option value={5}>5 - Perfect</option>
    ...
    if (this.state.meta.Fit) {
      fit = (
        <Form.Group>
          <Form.Label id='formQuestions'>
            Was the Fit Accurate With the Listing?*
          </Form.Label>
          <Form.Control
            id='reviewDropdown'
            as='select'
            ...
            onChange={this.handleChange}
            name='fit'
            className={this.state.fitError ? 'error' : ''}>
            <option value={0}>None Selected</option>
    ...
    if (this.state.meta.Size) {
      size = (
        <Form.Group>
          <Form.Label id='formQuestions'>
            Was the Size Accurate With the Listing?*
          </Form.Label>
          <Form.Control
            id='reviewDropdown'
            as='select'
            ...
            onChange={this.handleChange}
            name='size'
            className={this.state.sizeError ? 'error' : ''}>
    ...
    if (this.state.meta.Length) {
      length = (
        <Form.Group>
          <Form.Label id='formQuestions'>
            Was the Length Accurate With the Listing?*
          </Form.Label>
          <Form.Control
            id='reviewDropdown'
            as='select'
            ...
            onChange={this.handleChange}
            name='length'
            className={this.state.lengthError ? 'error' : ''}>
            <option value={0}>None Selected</option>
    ...
    if (this.state.meta.Width) {
      width = (
        <Form.Group>
          <Form.Label id='formQuestions'>
            Was the Width Accurate With the Listing?*
          </Form.Label>
          <Form.Control
            id='reviewDropdown'
            as='select'
            ...
            onChange={this.handleChange}
            name='width'
            className={this.state.widthError ? 'error' : ''}>
            <option value={0}>None Selected</option>
    ...
    if (
      ...
      requirementsHeader = (
        <ul id='errorMessageHeader'>Correct the Following:</ul>
      );
    }
    ...
    if (this.state.doRecommendError) {
      recommendError = (
        <li id='errorMessage'>
          Please fill in yes or no for recommending product
        </li>
      );
    }
    ...
    if (this.state.bodyError) {
      bodyError = (
        <li id='errorMessage'>Please fill in the body of the review</li>
      );
    }
    if (this.state.qualityError && this.state.meta.Quality) {
      qualityError = (
        <li id='errorMessage'>Please fill in the quality rating</li>
      );
    }
    if (this.state.comfortError && this.state.meta.Comfort) {
      comfortError = (
        <li id='errorMessage'>Please fill in the comfort rating</li>
      );
    }
        ...
        <Form id='addReviewForm'>
            ...
            <Col>
              <Form.Group>
                ...
                <Form.Control
                  ...
                  onChange={this.handleChange}
                  className={this.state.nicknameError ? 'error' : ''}
                />
                <p id='finePrint'>
          ...
          <Form.Group>
            <Form.Row>
              <br></br>
              <Form.Label
                className={this.state.starsError ? 'error' : ''}
                id='formQuestionsRadio'>
              ...
              />{' '}
              <p id='starRatingLabel'>{this.state.starRatingLabel}</p>
            </Form.Row>
          </Form.Group>
          <Form.Group>
            <Form.Label
              inline
              id='formQuestions'
              className={this.state.doRecommendError ? 'error' : ''}>
          ...
          <Form.Group>
            ...
            <Form.Control
              ...
              onChange={this.handleChange}
              className={this.state.summaryError ? 'error' : ''}
            />
          ...
          <Form.Group>
            ...
            <Form.Control
              ...
              onChange={this.handleChange}
              className={this.state.bodyError ? 'error' : ''}
            />
            <p id='charCount'>
              <b>
                {this.state.bodyError
                  ? 'Review must be 50 characters or longer'
                  : ''}
              </b>{' '}
              &nbsp; &nbsp; &nbsp;{' '}
              {this.state.bodyChar >= 50
                ? 'Minimum Reached'
                : `Minimum Required Characters Left: ${
                    50 - this.state.bodyChar
                  }`}
            </p>
          </Form.Group>
          {quality}
          ...
          <Form.Group>
            <Form.Label id='formQuestions'>
              Share Photos of Your Purchase (max: 5)
            </Form.Label>
            <Form.Row>
              <Form.Control
                name='photoURL'
                type='text'
                placeholder='Enter Valid URL to Photo'
